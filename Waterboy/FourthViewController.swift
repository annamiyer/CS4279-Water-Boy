...
class FourthViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        print(dateString)
        let sheetNumber3 = (Int(dateString)! + 1)
        print(sheetNumber3)
        let sheetString3 = String(sheetNumber3)
        
        datePasser.text = sheetString3
        
        
        let storyURL = "https://sheets.googleapis.com/v4/spreadsheets/1iGIyo-q-gbKenMFKVDoO9UCHIEZukVlm7JAZokPy8dE/values/C" + sheetString3 + "%3AC" + sheetString3 + "?key=AIzaSyA47HxY_lhwJGKL-OV1ixJZ2fFjRiaVYLI"
        
        let titleURL = "https://sheets.googleapis.com/v4/spreadsheets/1iGIyo-q-gbKenMFKVDoO9UCHIEZukVlm7JAZokPy8dE/values/A" + sheetString3 + "%3AA" + sheetString3 + "?key=AIzaSyA47HxY_lhwJGKL-OV1ixJZ2fFjRiaVYLI"
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?){
        ...
        fifthViewController.dateString = datePasser.text!
    }
